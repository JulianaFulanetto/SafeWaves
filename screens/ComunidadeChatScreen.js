        ...
        <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.cardTop}>
            ...
            <Text style={styles.cardTopDesc}>
              Conecte-se com vizinhos e instituições locais para uma segurança colaborativa
            </Text>
          </View>
 ...
 >
          ...
          <View style={styles.msgCard}>
            ...
            <Text style={styles.msgText}>
              Pessoal, viram alguma movimentação estranha na Rua das Flores hoje à tarde?
            </Text>
          ...
          <View style={styles.msgCard}>
            ...
            <Text style={styles.msgText}>
              Boa tarde! Alguém tem o contato do eletricista que trabalhou na casa do Pedro?
            </Text>
          ...
          <View style={styles.msgCard}>
            ...
            <Text style={styles.msgText}>
              ATENÇÃO: Carro suspeito circulando devagar pela região. Placa ABC-1234.
            </Text>
  ...
  const createStyles = (theme) =>
    StyleSheet.create({
      ...
      scroll: { paddingHorizontal: 15, marginTop: 10 },
